...
!function (t,e) {
			...
			return s(t,[{
				...
				value: function () {
					...
					this.$container || (this.$container = document.createElement("div"),
						(t = this.$container.classList).add.apply(t,p(this.option("classNames.main").split(" "))),
	...
	var F = {
		...
		,N = function (t) {
			...
			function n(t) {
				...
				return i.slideNext = z(i.slideNext.bind(d(i)),250),
				...
				value: function () {
					...
					(this.$viewport = this.option("viewport") || this.$container.querySelector(".".concat(o).concat(a.viewport)),
						this.$viewport) || (this.$viewport = document.createElement("div"),
							(t = this.$viewport.classList).add.apply(t,p((o + a.viewport).split(" "))),
							(e = this.$viewport).append.apply(e,p(this.$container.childNodes)),
					...
					(this.$track = this.option("track") || this.$container.querySelector(".".concat(o).concat(a.track)),
						this.$track) || (this.$track = document.createElement("div"),
							(i = this.$track.classList).add.apply(i,p((o + a.track).split(" "))),
							(n = this.$track).append.apply(n,p(this.$viewport.childNodes)),
				...
				value: function (t) {
					if (!t) {
						...
						if ((t = document.createElement("div")).dataset.isTestEl = 1,
							...
							(e = t.classList).add.apply(e,p((this.option("prefix") + this.option("classNames.slide")).split(" "))),
							n.customClass)
							(i = t.classList).add.apply(i,p(n.customClass.split(" ")));
					...
					if (t) {
						if (!t.$el) {
							...
							if (n.dataset.index = t.index,
								(e = n.classList).add.apply(e,p((this.option("prefix") + this.option("classNames.slide")).split(" "))),
								t.customClass)
								(i = n.classList).add.apply(i,p(t.customClass.split(" ")));
			...
			return s(t,[{
				...
				value: function () {
					...
					t && (this.viewport = t,
						...
						this.fancybox.$container.addEventListener("wheel",this.onWheel,{
							passive: !1
						})
				}
			},{
				...
				value: function () {
					...
					t && (t.removeEventListener("resize",this.onResize),
						...
						this.fancybox.$container.removeEventListener("wheel",this.onWheel,{
							passive: !1
						})
				}
			},{
					...
					if (!e || "string" == typeof e) {
						...
						i || ("#" === e.charAt(0) ? i = "inline" : (n = e.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i = "html5video",
							...
							"html5video" !== i && "video" !== i || (t.video = x({},this.fancybox.option("Html.video"),t.video),
								t._width && t._height ? t.ratio = parseFloat(t._width) / parseFloat(t._height) : t.ratio = t.ratio || t.video.ratio || Y.video.ratio)
					}
				}
			},{
				key: "onReady",
	...
	var G = function () {
		...
		,K = {
			...
			activate: function (t) {
				K.pageXOffset = window.pageXOffset,
					K.pageYOffset = window.pageYOffset,
		...
		,Q = {
			...
			items: {
				...
				fullscreen: {
					...
					click: function (t) {
						t.preventDefault(),
							K.element() ? K.deactivate() : K.activate(this.fancybox.$container)
					}
				},
				slideshow: {
					type: "button",
				...
				value: function () {
					...
					if ("init" === this.state && (this.build(),
						...
						!t.Carousel.prevPage && (t.option("slideshow.autoStart") && this.Slideshow.activate(),
							t.option("fullscreen.autoStart") && !K.element())))
						try {
							K.activate(t.$container)
						} catch (t) { }
				}
			},{
				key: "onFsChange",
		...
		,at = function (t) {
			...
			function i(t) {
				...
				return o(this,i),
					...
					(n = e.call(this,x(!0,{},it,a))).bindHandlers(),
					n.state = "init",
					n.setItems(t),
			...
			return s(i,[{
				...
				value: function () {
					...
					e && (this.$root.insertAdjacentHTML("beforeend",this.localize(e)),
						...
						this.id || (this.id = this.options.id || ++ot,
					...
					if (!(i.ignoreFocusChange || ["init","closing","customClosing","destroy"].indexOf(this.state) > -1)) {
						...
						for (var e,n = this.$container,o = this.getSlide(),a = "done" === o.state ? o.$el : null,s = [],r = 0,l = Array.from(n.querySelectorAll(W)); r < l.length; r++) {
							...
							h && (d || u) ? (s.push(c),
								...
								(c.hasAttribute("autoFocus") || !e && d && !c.classList.contains("carousel__button")) && (e = c)) : (c.dataset.origTabindex = void 0 === c.dataset.origTabindex ? c.getAttribute("tabindex") : c.dataset.origTabindex,
									c.tabIndex = -1)
						}
						t ? s.indexOf(t.target) > -1 ? this.lastFocus = t.target : this.lastFocus === n ? H(s[s.length - 1]) : H(n) : this.option("autoFocus") && e ? H(e) : s.indexOf(document.activeElement) < 0 && H(n),
				...
				value: function (t) {
					...
					if ((!s || c || r) && (o = [].slice.call(document.querySelectorAll(t))),
						s && !r && (o = c ? o.filter((function (t) {
				...
				value: function (t) {
					...
					D && (i.openers.size || (/complete|interactive|loaded/.test(document.readyState) ? n() : document.addEventListener("DOMContentLoaded",n)),
						i.openers.set(t,e))
				}
			},{
				key: "unbind",
				...
				key: "getInstance",
				value: function (t) {
					return t ? nt[t] : Object.values(nt).reverse().find((function (t) {
